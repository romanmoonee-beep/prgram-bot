...
export function getMainMenuKeyboard() {
  return new InlineKeyboard()
    ...
    .text(`${EMOJIS.earn} ${TEXTS.earn}`, "earn")
    .row()
    .text(`${EMOJIS.advertise} ${TEXTS.advertise}`, "advertise")
    .text(`${EMOJIS.checks} ${TEXTS.checks}`, "checks")
    .row()
    .text(`${EMOJIS.referrals} ${TEXTS.referrals}`, "referrals")
    .text(`${EMOJIS.subscription} Проверка`, "subscription")
    .row()
...
export function getCabinetKeyboard(isAdmin: boolean = false) {
  const keyboard = new InlineKeyboard()
    ...
    .text(`${EMOJIS.money} Пополнить`, "cabinet_deposit")
    .row()
    .text(`${EMOJIS.chart} Мои задания`, "cabinet_tasks")
    .text(`${EMOJIS.bell} Уведомления`, "cabinet_notifications")
    .row()
...
export function getEarnKeyboard() {
  return new InlineKeyboard()
    ...
    .text(`${EMOJIS.group} Группы`, "earn_groups")
    .row()
    .text(`${EMOJIS.view} Посты`, "earn_posts")
    .text(`${EMOJIS.bot} Боты`, "earn_bots")
    .row()
    .text(`${EMOJIS.fire} Топ задания`, "earn_top")
    .text(`${EMOJIS.diamond} Премиум`, "earn_premium")
    .row()
...
export function getAdvertiseKeyboard() {
  return new InlineKeyboard()
    ...
    .text(`${EMOJIS.chart} Мои задания`, "advertise_my_tasks")
    .row()
    .text(`${EMOJIS.stats} Статистика`, "advertise_stats")
    .text(`${EMOJIS.diamond} Топ-продвижение`, "advertise_promote")
    .row()
    .text(`${EMOJIS.home} Главное меню`, "main_menu");
}
...
export function getChecksKeyboard() {
  return new InlineKeyboard()
    ...
    .text(`${EMOJIS.money} Мои чеки`, "checks_my")
    .row()
    .text(`${EMOJIS.gift} Активировать`, "checks_activate")
    .text(`${EMOJIS.stats} История`, "checks_history")
    .row()
    .text(`${EMOJIS.home} Главное меню`, "main_menu");
}
...
export function getReferralsKeyboard() {
  return new InlineKeyboard()
    ...
    .text(`${EMOJIS.stats} Статистика`, "referrals_stats")
    .row()
    .text(`${EMOJIS.gift} Мои рефералы`, "referrals_list")
    .text(`${EMOJIS.diamond} Бонусы`, "referrals_bonuses")
    .row()
    .text(`${EMOJIS.home} Главное меню`, "main_menu");
}
...
export function getOnlyBackKeyboard(backData: string) {
  return new InlineKeyboard().text(`${EMOJIS.back} Назад`, backData);
}
...
export function getAdminKeyboard() {
  return new InlineKeyboard()
    ...
    .text(`${EMOJIS.user} Пользователи`, "admin_users")
    .row()
    .text(`${EMOJIS.chart} Задания`, "admin_tasks")
    .text(`${EMOJIS.money} Транзакции`, "admin_transactions")
    .row()
    .text(`${EMOJIS.bell} Рассылка`, "admin_broadcast")
    .text(`${EMOJIS.settings} Настройки`, "admin_settings")
    .row()
    .text(`${EMOJIS.home} Главное меню`, "main_menu");
}
